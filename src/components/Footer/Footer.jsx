...
function Footer() {
  return (
    <footer className='h-[80vh] sm:h-[55vh] xl:h-[60vh] w-[96%] sm:w-[98%] bg-[#00491f] rounded-t-[20px] md:rounded-t-[100px] relative overflow-hidden'>
      ...
      <div className="w-full z-20 flex flex-col justify-between items-center h-full gap-20 text-white pb-10">
        ...
        <div className="flex flex-col md:flex-row justify-around w-full items-center">
          ...
          <div className="flex flex-col sm:flex-col font-bold text-white/60 gap-3 sm:gap-10 w-full p-8 xl:pt-14">
            <Link to={'/'}>INICIO</Link>
        ...
        <div className="absolute top-1/2 sm:top-12 md:top-10 lg:top-20 xl:top-28 left-1/2 transform -translate-x-1/2 -translate-y-1/2 sm:translate-y-0  flex flex-col justify-center items-center gap-6 opacity-45 z-30">
      ...
      <p className='hidden md:block absolute text-[18vw] font-extrabold opacity-5 left-1/2 transform -translate-x-1/2 bottom-0  text-white leading-65 z-0'>PLASTICOS</p>
